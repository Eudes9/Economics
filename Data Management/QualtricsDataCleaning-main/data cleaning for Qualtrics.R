...
#Latest update: December 29th, 2024
...
setwd("C:/Users/jeane/Documents/project to do/QualtricsDataCleaning-main/QualtricsDataCleaning-main")
...
#I create a second dataframe named d2 with only the variables we want. Note that while selecting variables, you can also rename them
